...
/// and keeps its own recorded version.
///
/// `9` adds [`IntegrateArtifact::maps`]: the phase-space map choices the run
...
/// Schema versions 6 through 8, kept so artifacts banked before the map choices
