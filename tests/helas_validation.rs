...
//!
//! The reference file `validation/helas/reference.csv` must exist before
//! running this test.  Generate it with:
//!
//!     pixi run -e helas-validation build-helas
//!     pixi run -e helas-validation gen-reference
//!
//! All tests in this file are marked `#[ignore]` until the Rust HELAS
//! implementation in `src/lib.rs` is complete.  Run them with:
//!
...
#[test]
#[ignore = "Rust HELAS not yet implemented; run after src/lib.rs helas module is complete"]
