...
adaptive stratification; the crate implements the classic algorithm, since
the diagonal structure that stratification helps with is handled by the
channel decomposition instead.
